...
var total_value1 = financesArraytest.reduce(
    (acc_Value, cur_Value) => acc_Value + cur_Value,
    0);
console.log("total profit over entire months: $",total_value1);
document.getElementById("profit").innerHTML="Total profit over entire months: $"+total_value1;


//average-------------------------------------------------------------
var finances_average = total_value1 / (finances.length-1); //(Total/(Number of months - 1))
